...
module.exports = (req, res, next) => {
  if (!req.currentUser.role.includes(USER_ROLE.ADMIN)) {
    LoggerUtils.errorAction(AUDIT_LOG_FORMAT.ACTION, currentFileName, AUDIT_LOG_ACTION.LOGIN, AUDIT_LOG_STATUS.UNAUTHORIZED, req.currentUser.email)
